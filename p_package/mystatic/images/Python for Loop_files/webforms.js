            ...
            if ($form.data('ml-submit-bound') === undefined || !$form.data('ml-submit-bound')) {
                ...
                $form.bind('submit', function (e) {
                    ...
                    if (ml_validate_form($form)) {
                        ...
                        if (!preview || form_data.toLowerCase().includes('email')) {
                            ml_jQuery.ajax({
                                type: 'GET',
                                url: form_url,
                                data: form_data,
                        ...
                        if ($form.data('redirect')) {
                            if (preview) {
                                window.top.open($form.data('redirect'));
                            } else {
                                window.parent.postMessage('mlWebformRedirect-' + encodeURIComponent($form.data('redirect')), "*");
                            }
                        }
                    }
                });
